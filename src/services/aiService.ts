...
2. A detailed description (3-4 paragraphs with timestamps)
...
Stay tuned for more crypto alpha!`,
    tags: ['crypto', 'bitcoin', 'ethereum', 'defi', 'cryptocurrency', 'trading', 'crypto news'],
    script: `Yo what's up degens! Crypto B here, and we've got some absolutely INSANE crypto news dropping in the last 4 hours. If you're not paying attention, you're missing out on some serious alpha. Let's dive in!
...
That's all for now degens. Keep those diamond hands strong, and I'll catch you in the next one. Peace!`,
    topics
  };
}
